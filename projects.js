const projects = [
  {
    ...
    image: 'assets/images/project-bazarsip-main.png', // TODO: Ganti gambar ini
    tags: ['UI/UX Design', 'Design System', 'Front-End', 'Web App'],
    details: `
      <div class="modal__image-gallery">
        <img src="assets/images/project-bazarsip-1.png" alt="Bazarsip Customer Storefront Mockup">
        <img src="assets/images/project-bazarsip-2.png" alt="Bazarsip Admin Dashboard Mockup">
      </div>
